...
<head>
    ...
    <title>@yield('title', 'Smart-Hub') — Smart-Hub Member</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-control:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(13,148,136,.15); }
...
<aside class="sidebar">
    <div class="sidebar-logo">
        ...
        <div>
            ...
            <div class="logo-sub">Member Area</div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            <div class="nav-section-label">Fasilitas</div>
            <a href="{{ route('member.inventories.index') }}" class="nav-item {{ request()->routeIs('member.inventories.*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/>
                </svg>
                Inventaris Tersedia
            </a>
            <a href="{{ route('member.schedules.index') }}" class="nav-item {{ request()->routeIs('member.schedules.*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar-footer">
        <div class="user-card">
            ...
            <div class="user-info">
                <div class="user-name">{{ auth()->user()->name ?? 'Member' }}</div>
